...
public class VideoBlocker {
	...
	private static final Set<String> defaultPrefLanguages = new HashSet<>(SafetoonsApp.getStringArrayAsList(R.array.languages_iso639_codes));
	...
	public List<YouTubeVideo> filter(List<YouTubeVideo> videosList) {
		...
		final Set<String>   preferredLanguages    = SafetoonsApp.getPreferenceManager().getStringSet(getStr(R.string.pref_key_preferred_languages), defaultPrefLanguages);
	...
	private boolean isVideoBlockerEnabled() {
		return SafetoonsApp.getPreferenceManager().getBoolean(getStr(R.string.pref_key_enable_video_blocker), true);
	}
	...
	public static boolean isChannelBlacklistEnabled() {
		final String channelFilter = SafetoonsApp.getPreferenceManager().getString(getStr(R.string.pref_key_channel_filter_method), getStr(R.string.channel_blacklisting_filtering));
	...
	private boolean filterByLanguageDetection(YouTubeVideo video, Set<String> preferredLanguages) {
		...
		if (!SafetoonsApp.getPreferenceManager().getBoolean(getStr(R.string.pref_key_lang_detection_video_filtering), false))
			return false;
	...
	private BigInteger getViewsFilteringValue() {
		final  String viewsFiltering = SafetoonsApp.getPreferenceManager().getString(getStr(R.string.pref_key_low_views_filter), getStr(R.string.views_filtering_disabled));
	...
	private int getDislikesFilteringValue() {
		final  String dislikesFiltering = SafetoonsApp.getPreferenceManager().getString(getStr(R.string.pref_key_dislikes_filter), getStr(R.string.dislikes_filtering_disabled));
