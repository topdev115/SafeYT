...
public class YouTubeVideo implements Serializable {
	...
	public void privateListVideo(final Context context, final Menu menuPrivateList) {

		List<String> privateListsList = PrivateListsDb.getPrivateListsDb().getPrivateLists();

        final String[] privateLists = (privateListsList).toArray(new String[privateListsList.size()]);

		AlertDialog.Builder builder = new AlertDialog.Builder(context);

		builder.setTitle(R.string.select_private_list)
				.setItems(privateLists, new DialogInterface.OnClickListener() {

					public void onClick(DialogInterface dialog, int which) {

						if(PrivateListsDb.getPrivateListsDb().isPrivateListed(privateLists[which], YouTubeVideo.this) == false) {
							boolean successPrivateList = PrivateListsDb.getPrivateListsDb().add(YouTubeVideo.this, privateLists[which]);

							Toast.makeText(context, successPrivateList ? R.string.video_privatelisted : R.string.video_privatelisted_error,
											Toast.LENGTH_LONG).show();

							if (successPrivateList) {
								//menuPrivateList.findItem(R.id.private_list_video).setVisible(false);
								menuPrivateList.findItem(R.id.unprivate_list_video).setVisible(true);
							}
						}
						else {
							Toast.makeText(context, R.string.video_already_privatelisted, Toast.LENGTH_LONG).show();
						}
					}
				});
		...
		builder.setNeutralButton(R.string.new_private_list, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						AlertDialog.Builder builder = new AlertDialog.Builder(context);

						builder.setTitle(R.string.create_private_list);
						...
						builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialogInterface, int i) {
								//Toast.makeText(context, "Text entered is " + input.getText().toString(), Toast.LENGTH_LONG).show();

								String privateList = input.getText().toString();

								PrivateListsDb.getPrivateListsDb().add(privateList);

								boolean successPrivateList = PrivateListsDb.getPrivateListsDb().add(YouTubeVideo.this, privateList);
								...
								Toast.makeText(context,
										successPrivateList ? R.string.private_list_created_video_privatelisted : R.string.private_list_created_video_privatelisted_error,
										Toast.LENGTH_LONG).show();
							}
						});
	...
	public void privateListVideo(final Context context, final ImageView viewUnPrivateList) {
	...
	public static void privateListMultipleVideos(final Context context, final Iterator<YouTubeVideo> iterator) {
		...
		builder.setTitle(R.string.select_private_list)
				.setItems(privateLists, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						boolean successPrivateList = PrivateListsDb.getPrivateListsDb().add(iterator, privateLists[which]);
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						...
						boolean successPrivateList = PrivateListsDb.getPrivateListsDb().add(iterator, privateList);
	...
	public void unPrivateListVideo(final Context context, final Menu menuPrivateList, String searchQuery) {

		Log.i("unPrivateListVideo", "" + searchQuery);
		Log.i("unPrivateListVideo", "" + this.getId());

		if(searchQuery != null && this.getId() != null ){
			boolean successUnprivatelist = PrivateListsDb.getPrivateListsDb().remove(searchQuery, this);

			Toast.makeText(context,
					successUnprivatelist ? R.string.video_unprivatelisted : R.string.video_unprivatelisted_error,
					Toast.LENGTH_LONG).show();

			if (successUnprivatelist) {
				//menuPrivateList.findItem(R.id.private_list_video).setVisible(true);
				menuPrivateList.findItem(R.id.unprivate_list_video).setVisible(false);
			}
		}
	}

	public void unPrivateListVideo(final Context context, final ImageView viewUnPrivateList, String searchQuery) {
