...
package com.zaytoona.youtube.safe.gui.businessobjects.updates;
...
/**
 * A task that will check if any Safetoons updates have been published.  If there are, then the
 * user will be notified.
 */
public class UpdatesCheckerTask extends AsyncTaskParallel<Void, Void, UpdatesChecker> {

	/** If set to true, it will display the "Safetoons is up to date" message.  */
	 ...
	 * @param displayUpToDateMessage    If set to true, it will display the "Safetoons is up to date"
