...
public class SubscriptionsTable {
	...
	public static final String COL_CHANNEL_ALLOWED = "Channel_Allowed";
	public static final String COL_CHANNEL_HIDDEN = "Channel_Hidden";
	...
	public static String getCreateStatement() {
		return "CREATE TABLE " + TABLE_NAME + " (" +
				...
				COL_CHANNEL_TITLE + " TEXT UNIQUE NOT NULL, " +
				COL_LAST_VISIT_TIME + " TIMESTAMP DEFAULT (strftime('%s', 'now')), " +
				COL_CHANNEL_ALLOWED + " INT, " +
				COL_CHANNEL_HIDDEN + " INT " +
		" )";
	}
