...
import com.zaytoona.youtube.safe.gui.activities.PermissionsActivity;
...
public abstract class FileDownloader implements Serializable, PermissionsActivity.PermissionsTask {
	...
	private class FileInformation {
		...
		public FileInformation(String downloadFileName) {
			...
			boolean toDirectories = SafetoonsApp.getPreferenceManager().getBoolean(DOWNLOADS_TO_SEPARATE_DIRECTORIES,false);
