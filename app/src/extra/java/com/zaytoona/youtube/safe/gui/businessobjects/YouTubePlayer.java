...
public class YouTubePlayer {
	...
	private static boolean useOfficialYouTubePlayer(Context context) {
		...
		String              str = sharedPref.getString(SafetoonsApp.getStr(R.string.pref_key_choose_player), SafetoonsApp.getStr(R.string.pref_default_player_value));

		return  (str.equals(SafetoonsApp.getStr(R.string.pref_official_player_value)));
	}
