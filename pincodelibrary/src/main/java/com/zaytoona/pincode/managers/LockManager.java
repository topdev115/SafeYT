...
/**
 * Allows to handle the {@link com.zaytoona.pincode.managers.AppLock} from within
...
public class LockManager<T extends AppLockActivity> {
    ...
    /**
     * The static singleton instance of {@link com.zaytoona.pincode.managers.AppLock}
     */
     ...
     * {@link com.zaytoona.pincode.PinActivity}
     */
    ...
    /**
     * Tells the app if the {@link com.zaytoona.pincode.managers.AppLock} is enabled or not
     */
    public boolean isAppLockEnabled() {
        return (mAppLocker != null && (PinActivity.hasListeners() ||
                PinFragmentActivity.hasListeners() || PinCompatActivity.hasListeners() || PinPreferenceActivity.hasListeners()));
    }
