...
public abstract class AppLock {
    ...
    /**
     * ENABLE_PINLOCK_FOR_CHANGE type, used when changing the password
     */
    public static final int ENABLE_PINLOCK_FOR_CHANGE = 5;

    /**
     * CONFIRM_PIN_FOR_CHANGE type, used to confirm the new password when changing the password
     */
    public static final int CONFIRM_PIN_FOR_CHANGE = 6;
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link com.zaytoona.pincode.managers.AppLockActivity}
     ...
     * take into account for the {@link com.zaytoona.pincode.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link com.zaytoona.pincode.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link com.zaytoona.pincode.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link com.zaytoona.pincode.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link com.zaytoona.pincode.managers.AppLockActivity}
     */
    public abstract boolean shouldShowForgot(int appLockType);

    /**
     * Set the forgot option used by {@link com.zaytoona.pincode.managers.AppLockActivity}
     */
    ...
    /**
     * Enable the {@link com.zaytoona.pincode.managers.AppLock} by setting
     * {@link com.zaytoona.pincode.managers.AppLockImpl} as the
     * {@link com.zaytoona.pincode.interfaces.LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link com.zaytoona.pincode.managers.AppLock} by removing any
     * {@link com.zaytoona.pincode.interfaces.LifeCycleInterface}
     */
    ...
    /**
     * Disable the {@link com.zaytoona.pincode.managers.AppLock} by removing any
     * {@link com.zaytoona.pincode.interfaces.LifeCycleInterface} and also delete
     ...
     * Set in {@link com.zaytoona.pincode.interfaces.LifeCycleInterface#onActivityPaused(android.app.Activity)}
     * and {@link com.zaytoona.pincode.interfaces.LifeCycleInterface#onActivityResumed(android.app.Activity)}
     */
     ...
     * Get the last active time of the app used by {@link #shouldLockSceen(android.app.Activity)}
     */
    public abstract void resetLastActiveMillis();


    /**
     * Set the passcode (store his SHA1 into {@link android.content.SharedPreferences}) using the
     * {@link com.zaytoona.pincode.encryption.Encryptor} class.
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link com.zaytoona.pincode.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link com.zaytoona.pincode.managers.AppLockActivity} (it returns false)
